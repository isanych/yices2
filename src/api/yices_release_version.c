...
EXPORTED const char * const yices_build_date = "2023-06-27";
EXPORTED const char * const yices_build_arch = "unknown";

#if defined(YICES_STATIC)
EXPORTED const char * const yices_build_mode = "/static";
#else
EXPORTED const char * const yices_build_mode = "";
#endif

EXPORTED const char * const yices_rev = "0";
