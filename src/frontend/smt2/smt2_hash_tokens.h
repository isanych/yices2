...
/* Command-line: /opt/vcpkg/installed/x64-linux/tools/gperf/gperf -C -L ANSI-C -W smt2_tk -H hash_tk -E --output-file=frontend/smt2/smt2_hash_tokens.h --lookup-function-name=in_smt2_tk frontend/smt2/smt2_tokens.txt  */
