...
/* Command-line: /usr/bin/gperf -C -L ANSI-C -W smt2_kw -H hash_kw -E --output-file=frontend/smt2/smt2_hash_keywords.h --lookup-function-name=in_smt2_kw frontend/smt2/smt2_keywords.txt  */
