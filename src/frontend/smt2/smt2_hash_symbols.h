...
/* Command-line: /usr/bin/gperf -C -L ANSI-C -W smt2_sym -H hash_sym -E --output-file=frontend/smt2/smt2_hash_symbols.h --lookup-function-name=in_smt2_sym frontend/smt2/smt2_symbols.txt  */
