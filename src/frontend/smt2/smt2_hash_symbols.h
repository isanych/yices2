...
/* Command-line: /opt/vcpkg/installed/x64-linux/tools/gperf/gperf -C -L ANSI-C -W smt2_sym -H hash_sym -E --output-file=frontend/smt2/smt2_hash_symbols.h --lookup-function-name=in_smt2_sym frontend/smt2/smt2_symbols.txt  */
...
in_smt2_sym (register const char *str, register size_t len)
{
  enum
    {
      TOTAL_KEYWORDS = 69,
