...
/* Command-line: /usr/bin/gperf -C -L ANSI-C -W yices_kw --output-file=frontend/yices/yices_hash_keywords.h --lookup-function-name=in_yices_kw frontend/yices/yices_keywords.txt  */
