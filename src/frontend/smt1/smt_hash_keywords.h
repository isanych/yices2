...
/* Command-line: /usr/bin/gperf -C -L ANSI-C -W smt_kw --output-file=frontend/smt1/smt_hash_keywords.h --lookup-function-name=in_smt_kw frontend/smt1/smt_keywords.txt  */
