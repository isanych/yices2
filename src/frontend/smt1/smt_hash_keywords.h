...
/* Command-line: /opt/vcpkg/installed/x64-linux/tools/gperf/gperf -C -L ANSI-C -W smt_kw --output-file=frontend/smt1/smt_hash_keywords.h --lookup-function-name=in_smt_kw frontend/smt1/smt_keywords.txt  */
...
in_smt_kw (register const char *str, register size_t len)
{
