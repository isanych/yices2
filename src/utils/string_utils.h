 ...
 * Return -1 otherwise.
 */
extern int32_t binary_search_string(const char *s, const char * const *a, const int32_t n);
 ...
 * Otherwise, return -1.
 */
extern int32_t parse_as_keyword(const char *s, const char * const *a, const int32_t *b, const int32_t n);
